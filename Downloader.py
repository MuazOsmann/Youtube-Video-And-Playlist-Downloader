from PyQt5.QtWidgets import QApplication, QPushButton, QLineEdit, QLabel, QFileDialog, QMessageBox, QMainWindow, \
    QRadioButton, QFileDialog;
import PyQt5
import sys
import pytube

# TESTING COMMENT - IF U SEE THIS THEN I AM COLLABORATING
...
class Scene(QMainWindow):
    ...
    def exitevent(self):
        ExitConfirmation = QMessageBox.question(self, 'Exit', "Are you sure you want to exit?",
